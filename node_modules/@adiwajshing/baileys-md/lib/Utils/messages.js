...
const prepareWAMessageMedia = async (message, options) => {
    ...
    const [{ mediaUrl, directPath }] = await Promise.all([
        (() => {
            return options.upload(encWriteStream, { fileEncSha256B64, mediaType, timeoutMs: options.mediaUploadTimeoutMs });
        })(),
        (async () => {
            var _a;
            try {
        ...
        // remove tmp files
        didSaveToTmpPath && bodyPath && await fs_1.promises.unlink(bodyPath);
    });
